...
import json
import os
from odoo.addons.http_routing.models.ir_http import re
...
class bizcommonSliderSettings(http.Controller):
    ...
    @http.route(['/theme_nextbiz/blog_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/theme_nextbiz/blog_image_effect_config'], type='json', auth='public', website=True)
